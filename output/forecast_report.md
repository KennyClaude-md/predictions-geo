...
| `2027` | economy | **Peak EM/LIC external debt refinancing wall** | OECD/IMF flag 2026-2027 as the years of maximum interest-rate differential and rollover need for low- and middle-income sovereigns; with 10y UST at 4.6%+ this is the binding constraint. |
| `2027-01` | ai | **Hyperscaler Q4-2026 earnings with initial 2027 capex guidance** | The first collective statement on whether the ~$700B/yr buildout continues, plateaus, or is cut. Highest-leverage scheduled data point for the whole domain. |
| `2027-01` | ai | **Oracle–OpenAI ~$300B / 4.5GW compute contract begins** | Converts a paper commitment into cash obligations for a company with ~$25B ARR; a stress test of the circular-financing structure underpinning AI capex. |
| `2027-01` | ai | **California TFAIA first annual frontier-model transparency reports** | First mandatory public disclosure regime for US frontier labs; establishes whether state-level transparency survives federal preemption pressure. |
| `2027-02` | climate | **Southern Hemisphere coral bleaching season under peak El Nino** | Great Barrier Reef, Coral Triangle and western Indian Ocean simultaneously exposed; every strong El Nino since 1998 has coincided with a global bleaching event. |
| `2027-04` | geopolitics | **French presidential election** | A nationalist-right presidency would reshape EU sanctions unanimity, Ukraine aid, and the future of French extended deterrence talk. |
| `2027-07-15` | geopolitics | **EU/G7 Russian oil price cap freeze expires** | Reopens the dynamic-mechanism fight that nearly raised the cap to ~$58 during the Hormuz shock. |
| `2027-08-01` | geopolitics | **PLA 100th anniversary and Xi's 2027 capability milestone** | Widely used as the benchmark date for PLA 'capability to take Taiwan'; watch it as capability, not intent. |
| `2027-10` | geopolitics | **21st National Congress of the Chinese Communist Party** | Xi's succession signalling and the post-purge PLA leadership slate set the risk-appetite of the next five years. |
| `2027-10` | economy | **China 21st Party Congress** | Leadership and economic-model decision point; historically preceded by growth-supporting stimulus and followed by consolidation. |
| `2027-10-31` | economy | **ECB President Lagarde's term ends** | Succession fight during a period when the ECB is hiking into a supply shock and French sovereign risk is elevated; determines TPI willingness. |
| `2027-11` | climate | **COP32 (host expected to be Ethiopia / Addis Ababa - not verified this session)** | First African-hosted COP of this cycle; adaptation finance and loss-and-damage operationalization are the likely centre of gravity. |
| `2027-12` | climate | **Expected warmest calendar year on record (post-El Nino lag year)** | The 2015/2016 analogue implies peak global temperature response roughly a year after the ENSO peak; 2027 is the leading candidate for a new record, plausibly 1.65-1.80C. |
| `2027-12` | ai | **China domestic DUV lithography scale-up to ~20 units/year** | The measurable test of whether Chinese lithography self-sufficiency is real. Determines the residual leverage of US export controls after 2028. |
| `2027-12-02` | ai | **EU AI Act: Annex III high-risk obligations apply (deferred from 2026-08 by Digital Omnibus)** | The main compliance burden for AI deployers in hiring, credit, education, and law enforcement. Slippage again would signal Europe has effectively deregulated. |
| `2028-01` | geopolitics | **Taiwan presidential and legislative elections** | A third DPP term or a KMT restoration is the single largest swing factor in cross-Strait coercion levels for 2028-2032. |
| `2028` | climate | **IPCC Seventh Assessment Report Working Group reports (timeline from pre-2026 knowledge, not verified)** | First full assessment since AR6; will formally re-estimate climate sensitivity, the post-2023 warming acceleration, and current human-induced warming relative to 1.5C. |
| `2028-04` | economy | **Bank of Japan Governor Ueda's term ends** | With the policy rate at 1%, JGB yields at multi-decade highs and debt/GDP at 236.7%, the successor choice under a fiscally expansionary Takaichi government is a global duration event. |
| `2028-08-02` | ai | **EU AI Act: Annex I product-embedded high-risk obligations apply** | Extends the regime to medical devices, machinery, and vehicles — the point at which AI regulation intersects physical product liability. |
